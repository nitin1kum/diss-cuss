        ...
        <div className="bg-card border shadow-lg border-border backdrop-blur-xl py-8 px-6 rounded-lg sm:px-10">
          ...
          <div className="mt-6 relative">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="bg-card text-subtext px-2 text-gray-500">Or continue with email</span>
            </div>
          </div>

          <form className="mt-6 space-y-6" onSubmit={handleSubmit} noValidate>
            <div>
              <label htmlFor="email" className="block text-sm font-medium mb-2 text-subtext">
                Email address
              </label>
              <input
                id="email"
